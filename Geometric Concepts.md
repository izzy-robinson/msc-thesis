...
\mathbf{aff}(S) = \set{\sum_{i=1}^{k} \mu_i x_i | {x_i}_{i=1}^k \in S, \mu_i \in \mathbb{R} \forall i \in \set{1,...,k}, \sum_{i=1}^{k} \mu_i = 1},
``````
...
\mathbf{conv}(S) = \set{\sum_{i=1}^{k} \mu_i x_i | {x_i}_{i=1}^k \in S,\mu_i \in [0,1] \forall i \in \set{1,...,k}, \sum_{i=1}^{k} \mu_i = 1},
```
