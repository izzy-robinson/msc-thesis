...
It can be seen that, whereas our point is by construction local in the settings [(1,2),(1,2)] and [(1,3),(1,3)], their point is local in the settings [(1,3),(1,3)], [(1,2),(1,3)] and [(1,3),(1,2)].