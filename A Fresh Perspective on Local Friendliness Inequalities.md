...
It can be seen that, whereas our point is by construction local in the settings [(1,2),(1,2)] and [(1,3),(1,3)], their point is local in the settings [(1,3),(1,3)], [(1,2),(1,3)] and [(1,3),(1,2)]. It is reasonable to expect locality in the settings where both parties use a $1$ as this corresponds to both parties ooening the box and asking its occupant for their result. An interesting question would be whether it is possible to find a point which is local in all four such setting combinations, as both our point and their point fail in this task.